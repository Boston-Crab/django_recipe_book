            ...
            if data['meals'] is not None:
                for meal in data['meals']:
                    for i in range(1, 21):
                        ...
                        if ingredient_key in meal and (meal[ingredient_key] == '' or meal[ingredient_key] is None):
                            del meal[ingredient_key]
                        if measurement_key in meal and (meal[measurement_key] == '' or meal[measurement_key] is None):
